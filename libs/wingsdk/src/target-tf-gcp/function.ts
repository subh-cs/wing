...
export class Function extends cloud.Function {
  ...
  constructor(
    ...
    this.bucketObject = new StorageBucketObject(this, "FunctionCodeBucketObject", {
  ...
  public _toInflight(): string {
    // Implement the logic to convert the Google Cloud Function to an Inflight resource
    throw new Error("cloud.Function cannot be used as an Inflight resource on Google Cloud yet");
  }
}
